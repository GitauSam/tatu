document.querySelector("#SearchCriteriaDiv > div:nth-child(51)")
document.querySelector("#VehicleTypeSaloon")
document.querySelector("#VehicleTypeMPV-0-7")
document.querySelector("#VehicleTypeAny")

includeScript ('./booking/jquery-ui-1.10.3.custom.min.js');
includeScript ('./booking/jquery.fancyform.js');
includeScript ('./booking/jquery.placeholder.js');
includeScript ('./booking/regula.js');
